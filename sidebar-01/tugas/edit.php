...
<ul id="mbinsmenu0ebul_table" class="mbinsmenu0ebul_menulist css_menu"><center>
  <li><div class="buttonbg gradient_button gradient27" style="width: 100%;"><center><a href="view.php">MAHASISWA</a></center></div></li>
 ...
 <span class="navbar-toggler-icon"></span>    
   ...
   <input type="text" name="nama" class="form-control" value="<?php echo $data['nama']; ?>" required> 
    ...
    <div class="col-sm-10">    
	<input type="submit" name="submit" class="btn btnprimary" value="SIMPAN" href ="view.php">    
